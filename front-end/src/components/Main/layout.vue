<template>
    ...
    <div id="confirmPopup" class="fixed inset-0 bg-black bg-opacity-40 z-50 hidden">
        <div class="flex items-center justify-center h-full w-full box-border">
            <ul
                class="w-1/5 h-1/4 border border-solid border-gray-300 bg-white shadow-md flex flex-col justify-between text-sm">
                <li class="bg-orange-600 text-white text-lg font-bold">
                    <div id="confirmPopup_title" class="p-3 text-center"></div>
                </li>
                <li class="p-3">
                    <div id="confirmPopup_msg"></div>
                </li>
    ...
    <div>
        <nav class="lg:hidden flex items-center justify-between p-8 bg-gray-700">
            <div class="w-full xl:w-auto px-2 xl:mr-12">
                <div class="flex items-center justify-between">
                    <a class="inline-flex items-center w-16 h-8" href="#">
                        <img src="@/assets/Images/coffee_mini_logo.webp" alt="">
                    </a>
                    <div class="xl:hidden">
        ...
        <div class="hidden lg:block navbar-menu relative z-100">
            <div class="lg:hidden navbar-backdrop fixed top-0 left-0 w-full h-full bg-gray-800 opacity-50"></div>
            <nav
                class="fixed top-0 left-0 bottom-0  w-64 h-full flex flex-col pt-8 pb-4 px-4 bg-gray-700 overflow-auto">
                <div class="mb-6">
                    <a class="inline-block mb-12 w-full" href="#">
                        <img class="h-52 w-full" src="@/assets/Images/coffee_mini_logo.webp" alt="">
                    </a>

                    <ul>
                        <li class="mb-4">
                            <router-link to="/Home" class="flex items-center p-4 text-white bg-blue-500 rounded-xl"
                                href="#">
                                ...
                                <span class="ml-4 text-sm font-semibold">Dashboard</span>
                            </router-link>
                        </li>

                        <li class="mb-4">
                            <router-link to="/Home"
                                class="flex items-center p-4 text-gray-300 hover:bg-gray-800 rounded-xl" href="#">
                        ...
                        <li class="mb-4 cursor-pointer" @click="toggleSubmenu">
                            <div
                                class="flex flex-1 items-center justify-between p-4 text-gray-300 hover:bg-gray-800 rounded-xl">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-4 text-sm font-semibold">Manage</span>
                                </div>
                                <div class="ml-2 mr-4 cursor-pointer">
                                    <svg fill="#ccc" height="20" width="20" version="1.1" id="Layer_1"
                            ...
                            <div v-if="showSubmenu" class="ml-4 bg-gray-700 rounded-lg">
                                <router-link to="/Category"
                                    class="p-2 rounded-lg block mb-1 text-gray-300 hover:bg-gray-500">Categories</router-link>
                                <router-link to="/Product"
                                    class="p-2 rounded-lg block mt-1 text-gray-300 hover:bg-gray-500">Products</router-link>
                            </div>
                        </li>
                        ...
                        <li class="mb-4">
                            <router-link to="/Home"
                                ...
                                <span class="ml-4 mr-auto text-sm font-semibold">Orders</span>
                                <span
                                    class="flex items-center justify-center w-6 h-6 bg-blue-500 text-white text-xs font-semibold rounded-full">4</span>
                            </router-link>
                        </li>
                        ...
                        <li>
                            <router-link to="/Home"
                                ...
                                <span class="ml-4 text-sm font-semibold">Customers</span>
                            </router-link>
                        </li>
                    </ul>
                </div>
                ...
                <div class="mt-auto">
                    <router-link to="/Home"
                        class="flex items-center p-4 mb-4 text-gray-300 hover:bg-gray-800 rounded-xl">
                        <span class="text-gray-400">
        ...
        <div class="mx-auto lg:ml-64 p-3">
